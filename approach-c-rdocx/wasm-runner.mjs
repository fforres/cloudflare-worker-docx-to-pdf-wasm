#!/usr/bin/env node
// Drive the approach-c-rdocx WASM module from Node.js so the harness can score it.
...
const wasmPath =
  ...
  path.join(__dirname, "converter/target/wasm32-unknown-unknown/release/approach_c_rdocx.wasm");
