...
| 002 | [rdocx-textbox-content-not-extracted](002-rdocx-textbox-content-not-extracted.md) | MEDIUM | 1/25 doc in complex corpus produced empty PDF (UN SEEA brief); worked around in opt-7/opt-8 via a DOCX-XML preprocessor |
...
| 007 | [caladea-suspected-cmap-bug](007-caladea-suspected-cmap-bug.md) | UNCONFIRMED | Same architecture as issue 001; masked by opt-5+'s Liberation aliasing but not proven |
